          ...
          <div className="relative mt-6 flex-1 px-4 sm:px-6 flex flex-col">
            <div className="flex-1 relative">
              ...
              >
                ...
                <div
                  className={`${subCategoryMenu ? "hidden" : "flex"} pt-16 flex-col items-center sm:items-start space-y-6 bg-amber-300 absolute inset-x-0 inset-y-0 transition duration-300 ease-in data-[closed]:opacity-0 data-[enter]:duration-100 data-[enter]:data-[closed]:-translate-x-full data-[leave]:duration-300 data-[leave]:data-[closed]:translate-x-full`}
                  id="servicesNav"
                >
                  <Link
                    href="/locations"
                  ...
                  <button
                    onClick={() => openSubcategoryLinks("shelter-housing")}
              ...
              <div
                className={`${nestedNav ? "hidden" : "flex"} pt-16 flex-col items-center sm:items-start space-y-6`}
                id="main_menu"
              >
                <Link
                  href="/"
