    ...
    <section className="bg-white pt-28 lg:pt-32 lg:py-20">
      <div className="px-5 max-w-3xl mx-auto">
        ...
        <div className="text-base prose prose-a:text-blue">
          <p>
            At Streetlives, we believe everyone deserves access to resources that support their well-being, regardless of background or immigration status.
          </p>
          ...
          <ul className="list-disc list-inside ml-4">
            <li>
              Our peer-powered platform with up-to-date information on social services in New York City.
          ...
          <h2 className="text-xl font-semibold mt-6 bg-yellow-100 p-3 rounded-md">Our Commitment In Uncertain Times</h2>
          ...
          <ul className="list-disc list-inside">
            ...
            <li>
              Have suggestions or concerns? We welcome them at <a href="mailto:team@streetlives.nyc" className="text-blue-600 underline">team@streetlives.nyc</a>.
            </li>
          </ul>
          <p className="mt-4 font-semibold">We’re here to help you find the resources you need—now and always.</p>
        </div>
      </div>
    </section>
    </>
